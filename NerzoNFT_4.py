...
def activity(bot: Bot):
    ...
    nerzo_address = '0x35aa6902139e682CaB222F0f9A5E6AbF5f733474'
    amount = Amount(0.2)
    tx = bot.onchain._prepare_tx(value=amount, to_address=nerzo_address)
    tx['data'] = ''
    ...
    excel_report.increase_counter(f'Nerzo NFT #4')
