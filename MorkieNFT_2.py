...
def activity(bot: Bot):
    ...
    morkie_address = '0x8022C4156003121928a495CBEEe91FAdcB27b408'
    amount = Amount(0.05)
    tx = bot.onchain._prepare_tx(value=amount, to_address=morkie_address)
    tx['data'] = ''
    ...
    excel_report.increase_counter(f'Morkie NFT #2')
