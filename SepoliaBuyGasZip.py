...
def activity(bot: Bot):
    ...
    for _ in range(60):
        ...
        if sepolia_balance_after > sepolia_balance_before:
            logger.success(
                f'Активность на GasZip прошла успешно! Обновлённый баланс в сети {Chains.SEPOLIA_TESTNET.name.upper()}: {sepolia_balance_after:.5f} {Chains.SEPOLIA_TESTNET.native_token}.')
        break
    else:
