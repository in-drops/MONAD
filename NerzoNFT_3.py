...
def activity(bot: Bot):
    ...
    nerzo_address = '0x5DCC4Cc8F56295Cb486809C77d476B2ea09a6938'
    amount = Amount(0.02)
    tx = bot.onchain._prepare_tx(value=amount, to_address=nerzo_address)
    tx['data'] = ''
    ...
    excel_report.increase_counter(f'Nerzo NFT #3')
