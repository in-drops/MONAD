...
def activity(bot: Bot):
    ...
    magic_eden_address = '0x690CfACdc08dC7DA79736906CD506890D6ca224A'
    amount = Amount(0)
    tx = bot.onchain._prepare_tx(value=amount, to_address=magic_eden_address)
    tx['data'] = ''
    ...
    excel_report.increase_counter(f'MagicEden NFT #3')
