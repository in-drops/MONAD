...
def activity(bot: Bot):
    ...
    magic_eden_address = '0x66B655de495268eb4C7B70Bf4Ac1AB4094589F93'
    amount = Amount(0)
    tx = bot.onchain._prepare_tx(value=amount, to_address=magic_eden_address)
    tx['data'] = ''
    ...
    excel_report.increase_counter(f'MagicEden NFT #1')
