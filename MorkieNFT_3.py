...
def activity(bot: Bot):
    ...
    morkie_address = '0x8fb9EeDC9ae174C22B87FC8Cb87B902373D2a284'
    amount = Amount(0.5)
    tx = bot.onchain._prepare_tx(value=amount, to_address=morkie_address)
    tx['data'] = f'0x84bb1e42000000000000000000000000{bot.account.address[2:]}'
    ...
    excel_report.increase_counter(f'Morkie NFT #3')
